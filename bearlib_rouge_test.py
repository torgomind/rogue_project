...
# http://www.roguebasin.com/index.php?title=Complete_Roguelike_Tutorial,_using_python%2Blibtcod,_part_6_code#Untimely_deaths
...
def render_all():
    ...
    #show player stats
    terminal.print_(1, SCREEN_HEIGHT-2, 'HP: ' + str(player.fighter.hp) + '/' + str(player.fighter.max_hp) + '  ')
...
terminal.open()
terminal.set("window: size=80x50; window.title='hello world'; font: tilesets/NEW16_4.png, size=16x16;")

#create player object
fighter_component = Fighter(hp=30, defense=2, power=5, death_function=player_death)
player = Object(0, 0, '@', 'player', blocks=True, fighter=fighter_component)
...
while True:
    ...
    #terminal.put(10, 10, 13) #place individual tile
